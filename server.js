...
const { joinUser, removeUser, findUser, findAll } = require('./users');
...
io.on("connection", function (socket) {
  ...
  socket.on("join room", (data) => {
    ...
    socket.emit('send data', { id: socket.id, username: Newuser.username, roomname: Newuser.roomname, usersInRoom: users });
